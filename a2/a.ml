...
let rec execute (s,rho,opc) =
    match (s,opc) with
        ([x], [])->
            x
    |   (s, (CONST e)::c)->
            execute((Int e)::s, rho, c)
    |   (s, (TRUE)::c)->
            execute((Bool true)::s, rho, c)
    |   (s, (FALSE)::c)->
            execute((Bool false)::s, rho, c)
    |   (s, (VAR n)::c)->
            execute((rho n)::s, rho, c)
    |   (e::s, (ABS)::c)->
            execute((abss e)::s, rho, c)
    |   (e::s, (NOT)::c)->
            execute((nott e)::s, rho, c)
    |   (e2::e1::s, (PLUS)::c)->
            execute((addd(e1,e2))::s, rho, c)
    |   (e2::e1::s, (MINUS)::c)->
            execute((subb(e1,e2))::s, rho, c)
    |   (e2::e1::s, (MUL)::c)->
            execute((mull(e1,e2))::s, rho, c)
    |   (e2::e1::s, (DIV)::c)->
            execute((divv(e1,e2))::s, rho, c)
    |   (e2::e1::s, (MOD)::c)->
            execute((modd(e1,e2))::s, rho, c)
    |   (e2::e1::s, (POW)::c)->
            execute((expo(e1,e2))::s, rho, c)
    |   (e2::e1::s, (AND)::c)->
            execute((andd(e1,e2))::s, rho, c)
    |   (e2::e1::s, (ORR)::c)->
            execute((orrr(e1,e2))::s, rho, c)
    |   (e2::e1::s, (IMPLY)::c)->
            execute((implyy(e1,e2))::s, rho, c)
    |   (e2::e1::s, (EQUAL)::c)->
            execute((equall(e1,e2))::s, rho, c)
    |   (e2::e1::s, (GREAT)::c)->
            execute((greatt(e1,e2))::s, rho, c)
    |   (e2::e1::s, (LESSS)::c)->
            execute((lessss(e1,e2))::s, rho, c)
    |   (e2::e1::s, (GREQU)::c)->
            execute((grequu(e1,e2))::s, rho, c)
    |   (e2::e1::s, (LEEQU)::c)->
            execute((leequu(e1,e2))::s, rho, c)
    |   (s, (LIST e)::c)->
            execute((Listans (map_ex execute e))::s,rho,c)
;;
